...
class NFRessuprimentoViewModel(view: INFRessuprimentoView):
  CrudViewModel<ViewRessuprimento, QViewRessuprimento, NFRessuprimentoVo, INFRessuprimentoView>(view) {
  private val processing = NFRessuprimentoProcessamento()
  private val print = NFRessuprimentoPrint()
  private val find = RessuprimentoFind()
  
  override fun newBean(): NFRessuprimentoVo {
    return NFRessuprimentoVo()
  }
  
  override fun update(bean: NFRessuprimentoVo) {
    log?.error("Atualização não permitida")
  }
  
  override fun add(bean: NFRessuprimentoVo) {
    log?.error("Inserssão não permitida")
  }
  
  override fun delete(bean: NFRessuprimentoVo) {
  ...
  override fun ViewNotaFutura.toVO(): NFRessuprimentoVo {
    val bean = this
    return NFRessuprimentoVo().apply {
      numero = bean.numero
...
class NFRessuprimentoVo: EntityVo<ViewNotaFutura>() {
...
interface INFRessuprimentoView: ICrudView
