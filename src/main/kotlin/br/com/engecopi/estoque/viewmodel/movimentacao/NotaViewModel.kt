...
import br.com.engecopi.estoque.viewmodel.movimentacao.ETipoGrupo.*
...
abstract class NotaViewModel<VO : NotaVo, V : INotaView>(
  ...
  fun imprimirItem(itemNota: ItemNota?) = execString {
    print.imprimirItem(itemNota, statusImpressao).updateView()
  }

  fun imprimirNotaCompleta(itemNota: ItemNota?) = execString {
    print.imprimirNotaCompleta(itemNota, statusImpressao).updateView()
  }

  fun imprimirNotaCompletaAgrupada(itemNota: ItemNota?) = execString {
    print.imprimirNotaCompletaAgrupada(itemNota, statusImpressao).updateView()
  }

  fun imprimirItensPendentes() = execString {
    print.imprimirItensPendentes(statusImpressao).updateView()
  }

  fun imprimirItens(itens: List<ItemNota>) = execString {
    print.imprimirItens(itens, statusImpressao).updateView()
  }
