...
import br.com.engecopi.estoque.viewmodel.ressuprimento.*
...
class DlgRessuprimento(
  val localizacaoNota: LocalizacaoRessuprimento, val viewModel: ChaveRessuprimentoViewModel, val update: () -> Unit
) : Window("Itens da Ressuprimento") {
