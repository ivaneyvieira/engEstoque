SELECT DISTINCT CAST(IFNULL(X.xrouteno, '') AS CHAR) AS rota, N.storeno, N.nfno AS numero,
                N.nfse AS serie, N.issuedate AS date, N.issuedate AS dtEmissao, P.prdno AS prdno,
                P.grade, P.qtty AS quant, C.name AS clienteName,
                CASE
