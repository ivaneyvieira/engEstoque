...
alter table hitorico_etiquetas
    add constraint fk_hitorico_etiquetas_usuario_id foreign key (usuario_id) references usuarios (id) on delete restrict on update restrict;

create index ix_hitorico_etiquetas_produto_id on hitorico_etiquetas (produto_id);
alter table hitorico_etiquetas
    add constraint fk_hitorico_etiquetas_produto_id foreign key (produto_id) references produtos (id) on delete restrict on update restrict;
